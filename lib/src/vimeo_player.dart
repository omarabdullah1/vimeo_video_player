  ...
  Future<VimeoVideoConfig?> _getVimeoVideoConfig({
    ...
    try {
      ...
      Options dioOptions = Options(
        headers: {
          'Authorization':
              'Bearer 1c5f6ed85a1ce506e8bef9931ef32230', // Replace with your actual token
        },
      );

      Response responseData = await Dio().get(
        'https://player.vimeo.com/video/$vimeoVideoId/config',
        options: dioOptionsForVimeoVideoConfig ??
            dioOptions, // Pass provided options if available
      );
